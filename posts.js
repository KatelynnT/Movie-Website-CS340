...
router.post('/', function(req, res){
        ...
        var mysql = req.app.get('mysql');
        var sql = "INSERT INTO review (review_movie_tv, review_title, review_body) VALUES (?,?,?)";
	var inserts = [req.body.review_movie_tv, req.body.review_title, req.body.review_body];
